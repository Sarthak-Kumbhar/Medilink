  ...
  return (
    ...
    >
      <div className="w-full lg:w-1/2 h-full p-4 sm:p-6 md:p-8 flex flex-col justify-center">
        <h1 className="max-w-[400px] text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium">
      ...
      <div className="w-full lg:w-1/2 h-full flex justify-end p-4 sm:p-6 md:p-8">
        <div className="w-[45%] flex flex-col justify-end">
          <div className="w-full aspect-square border-s-2 border-t-2 border-b-2 border-gray-300 p-4 sm:p-6">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-medium text-orange-500 mt-4 sm:mt-8">
              15
            </h1>
            <hr className="mt-4 sm:mt-6 text-white" />
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium text-white mt-2 sm:mt-4">
              Modules
            </h1>
          </div>
        </div>
        ...
        <div className="w-[45%] flex flex-col justify-end">
          <div className="w-full aspect-square border-2 border-b-0 border-gray-300 p-4 sm:p-6">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-medium text-orange-500 mt-4 sm:mt-8">
              5
            </h1>
            <hr className="mt-4 sm:mt-6 text-white" />
          ...
          <div className="w-full aspect-square border-2  border-gray-300 p-4 sm:p-6">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-medium text-orange-500 mt-4 sm:mt-8">
              3
            </h1>
            <hr className="mt-4 sm:mt-6 text-white" />
